...
//		return str_repeat('&nbsp;', $count);
	 ...
	 */
	 function closeTag($ptag) {
        ...
        function combobox( $data, $optattr = null, $comboattr = null, $elem1 = false, $selected = '' ){
        $combo_opt = ''; 
...
//        echo $opt_label;
        ...
        $cont = 0;
            foreach ($data as $g) {
                if( $elem1 AND $cont == 0 ){
                    $txt_seleccionar = 'Seleccionar --';
                    if($elem1 != 1){
                       $txt_seleccionar = $elem1;
                    }
                    $combo_opt .= tagcontent('option', $txt_seleccionar, array('value'=>'-1'));
                    $cont ++;
//                    continue;
                }
