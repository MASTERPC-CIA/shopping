...
function get_input_button($label_btn, $attr_input, $btn_attr, $class = 'col-md-2'){
    $output = '';
    $output .= Open('div',array('class'=>$class));
        $output .= Open('div',array('class'=>'input-group'));
            $output .= input($attr_input);
             $output .= Open('span',array('class'=>'input-group-btn'));
                $output .= tagcontent('button', $label_btn, $btn_attr);
             $output .= Close('span');
//          $output .= tagcontent('span', $label, array('class'=>'input-group-addon'));
//          $output .= $combo;
        $output .= Close('div');
