                        ...
                        ?>
                            <div class="row">
                                <div class="section-title text-center">
                                    <h3>Registrarse</h3>
                                    <p>Si ya eres cliente de Master PC, puedes acceder con tu c&eacute;dula o ruc, tanto en usuario como en clave.</p>
                                </div>
                            </div>                    
                        <?php
...
//                                echo Close('tr');
                    ...
                    <div class="row">
                        <div class="section-title text-center">
                            ...
                            <p>Ingresa con tu usuario y contrase&ntilde;a para acceder a un servicio completo con muchas opciones disponibles.</p>
                        </div>
                    </div>
                    <div class="row">
