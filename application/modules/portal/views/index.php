...
<html lang="en">
    ...
    <head>
        ...
        echo input(array('type'=>'hidden','id'=>'main_path','value'=>  base_url()));        
            $css_files = array(
                base_url('resources/elevator/bootstrap/css/bootstrap.min.css'),
                base_url('resources/elevator/css/font-awesome.min.css'),
                base_url('resources/elevator/css/animate.css'),
                base_url('resources/elevator/css/style.css'),
            ...
            echo csslink($css_files);
            
            
            $js_files = array(
                base_url('resources/elevator/js/jquery-2.1.1.min.js'),
                base_url('resources/elevator/bootstrap/js/bootstrap.min.js'),
                base_url('resources/elevator/js/jquery.appear.js'),
                base_url('resources/elevator/js/contact_me.js'),
                base_url('resources/elevator/js/jqBootstrapValidation.js'),
                base_url('resources/elevator/js/modernizr.custom.js'),
                base_url('resources/elevator/js/script.js'),
    ...
    <?php //$this->load->view('navigator');?>
        ...
        <?php 
			$this->load->view('section_left');
			$this->load->view('section_right');
