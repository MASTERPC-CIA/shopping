                    ...
                    <?php
                            echo Open('table',array('class'=>'table table-striped'));
                                ...
                                echo Open('tr');
                                    ...
                                    $input = input(array('type'=>'text','name'=>'ci_ruc','id'=>'ci_ruc','value'=>'','class'=>'form-control','placeholder'=>'CI/RUC'));
                                    echo tagcontent('td',$input);
                                echo Close('tr');
                                echo Open('tr');
                                    echo tagcontent('th','Nombres');
                                    $input = input(array('type'=>'text','name'=>'nombres','id'=>'nombres','value'=>'','class'=>'form-control','placeholder'=>'Nombres'));
                                    echo tagcontent('td',$input);
                                echo Close('tr');
                                echo Open('tr');
                                    echo tagcontent('th','Apellidos');
                                    $input = input(array('type'=>'text','name'=>'apellidos','id'=>'apellidos','value'=>'','class'=>'form-control','placeholder'=>'Apellidos'));                
                                    echo tagcontent('td',$input);
                                echo Close('tr');
                                echo Open('tr');
                                    echo tagcontent('th','Direcci&oacute;n');
                                    $input = input(array('type'=>'text','name'=>'direccion','id'=>'direccion','value'=>'','class'=>'form-control','placeholder'=>'Direcci&oacute;n'));                                
                                    echo tagcontent('td',$input);
                                echo Close('tr');
                                echo Open('tr');
                                    echo tagcontent('th','E-mail');
                                    $input = input(array('type'=>'email','name'=>'email','id'=>'email','value'=>'','class'=>'form-control','placeholder'=>'Email'));
                                    echo tagcontent('td',$input);
                                echo Close('tr');

                                echo Open('tr');
                                    echo tagcontent('th','Usuario');
                                    $input = input(array('type'=>'text','name'=>'usuario','id'=>'usuario','value'=>'','class'=>'form-control','placeholder'=>'Usuario'));
                                    echo tagcontent('td',$input);
                                echo Close('tr');
                                echo Open('tr');
                                    echo tagcontent('th','Clave');
                                    $input = input(array('type'=>'text','name'=>'clave','id'=>'clave','value'=>'','class'=>'form-control','placeholder'=>'Clave'));
                                    echo tagcontent('td',$input);
                                echo Close('tr');
