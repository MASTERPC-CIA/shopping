                ...
                echo tablethead($thead);
                 ...
                 echo Open('tr');
                    ...
                    echo Open('tr');
                        ...
                        echo tagcontent('td', get_settings('IVA').'%');
...
//                echo tagcontent('button','<i class="icon-paypal on-right on-left"></i>COMPRA PAYPAL',array('type'=>'submit','class'=>'btn btn-primary btn-small pull-right','style'=>'margin:3px;'));
        ...
        echo Open('form',array('action'=>'https://www.2checkout.com/checkout/purchase','method'=>'post'));
            ...
            echo input(array('type'=>'hidden','name'=>'li_'.$num_imp.'_name','value'=>'IVA '.  get_settings('IVA').'%'));
...
//$comment = '<script type="text/javascript"> this.document.write(area) </script>';
            ...
            //if($tipocliente->tipo == 'Concesionarios'){
                ...
                echo Open('form', array('action' => base_url('shopping_cart/productos/send_notify_email/'), 'method' => 'post','class'=>'col-md-6 pull-right'));
                    ...
                    echo input(array('type'=>'hidden','name'=>'telefonos', 'value'=>$data_client->telefonos.'-'.$data_client->celular));
...
//                    echo input(array('type'=>'hidden','name'=>'comentario', 'value'=>$comment));
                    echo tagcontent('textarea','',array('id'=>'comentario','class'=>'form-control','name'=>'comentario','rows'=>'1','placeholder'=>'Escribenos tus observaciones ó sugerencias...'));
                    echo lineBreaK(1, array('class'=>'clr'));
                    if($tipocliente->tipo == 'Concesionarios'){
                    ...
                    echo tagcontent('button',$ema.' NOTIFICAR PEDIDO',array('type'=>'submit','class'=>'btn btn-success btn-small','style'=>'margin:3px;','data-target'=>'res_info','id'=>'ajaxformbtn'));
                echo Close('form');
