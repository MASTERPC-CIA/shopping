    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php   echo tagcontent('div', '', array('id'=>'login_out')); ?>
                ...
                <form id="loginForm" method="post" class="form-horizontal" action="<?=  base_url('login/verifylogin')?>">
                    <div class="form-group">
                        ...
                        <div class="col-xs-6 input-group">
                            <input type="text" class="form-control" name="username" placeholder="Usuario (C&eacute;dula o Ruc)"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-6 input-group">
                            <input type="password" class="form-control" name="password" placeholder="Contrase&ntilde;a (C&eacute;dula o Ruc)"/>
                    ...
                    <div class="form-group">
                        <div class="col-xs-10 col-xs-offset-3">
                            <button type="submit" class="btn btn-success" data-target="login_out">
                                Ingresar
                            ...
                            <button type="button" class="btn btn-primary" data-dismiss="modal" data-target="#registerModal" data-toggle="modal">
                                Registrarse
                                <span class="fa fa-book fa-f5"></span>
                            </button>
