...
?>
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="margin-bottom: 0;font-family: 'lucida grande',tahoma,verdana,arial,sans-serif">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" style="font-weight: bold; font-size: 38px" href="<?= base_url() ?>">master pc</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li><a href="<?=  base_url('user_conf/editprofile') ?>"><i class="fa fa-gear fa-fw"></i> Configuraci&oacute;n</a>
                        </li>
                        <li class="divider"></li>
