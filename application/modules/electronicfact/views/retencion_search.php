...
echo Open('form', array('action'=>  base_url('electronicfact/retencion/get_crud'),'method'=>'post'));
    ...
    $checkbox_data = array(
        '0' => array('type'=>'checkbox','name'=>'ver_anulados','value'=>'1'),
    );    
    $label_array = array('Anulados');
    $label_attr = array(
        '0' => array('class'=>'btn btn-warning')
    );
    echo get_check_group($label_array, $checkbox_data, $label_attr);    
